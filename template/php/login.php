  ...
  <body class="ps-loading">
        ...
        <div class="container-fluid">
          <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-6 col-xs-12 ">
                  <p>Jardim Rincão, São Paulo - CEP: 07714-660</p>
                </div>
                <div class="col-lg-6 col-md-4 col-sm-6 col-xs-12 ">
                  <div class="header__actions"><a href="#"></a>
                    <div class="btn-group ps-dropdown"><a class="dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Idioma<i class="fa fa-angle-down"></i></a>
                      <ul class="dropdown-menu">
                        <li><a href="#"><img src="../images/flag/bra.svg" alt=""> PT</a></li>
                        <li><a href="#"><img src="../images/flag/usa.svg" alt=""> EN</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
        ...
        <div class="container-fluid">
          ...
          <div class="navigation__column center">
                <ul class="main-menu menu">
                  <li class="menu-item menu-item-has-children dropdown"><a href="../index.html">NOVIDADES</a>
                        <ul class="sub-menu">
                  ...
                  <li class="menu-item menu-item-has-children has-mega-menu"><a href="#">masculino</a>
                    <div class="mega-menu">
                      <div class="mega-wrap">
                  ...
                  <li class="menu-item"><a href="#">Feminino</a></li>
    ...
    <div class="header-services">
      <div class="ps-services owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="7000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="false" data-owl-item="1" data-owl-item-xs="1" data-owl-item-sm="1" data-owl-item-md="1" data-owl-item-lg="1" data-owl-duration="1000" data-owl-mousedrag="on">
        <p class="ps-service"><i class="ps-icon-delivery"></i><strong>Calcule o frete</strong>: Frete grátis a partir de R$ 199 reais *Confira condições</p>
        <p class="ps-service"><i class="ps-icon-delivery"></i><strong>Calcule o frete</strong>: Frete grátis a partir de R$ 199 reais *Confira condições</p>
        <p class="ps-service"><i class="ps-icon-delivery"></i><strong>Calcule o frete</strong>: Frete grátis a partir de R$ 199 reais *Confira condições</p>
      </div>
    </div>
      ...
      <div class="ps-banner">
       ...
       <div class="ps-section--offer">
        ...
        <div class="ps-home-contact__form">
          <header>
            <h3>Já sou cliente LOJA</h3>
          </header>
          <article>
            <form action="index.html" method="post">
              <div class="form-group">
                <label>E-mail ou CPF<span>*</span></label>
                <input class="form-control" type="text" name="login" value="" placeholder="youremail@email.com / 000.000.000">
              </div>
              <div class="form-group">
          ...
          <article>
            <form action="cadastroCliente.php" method="post">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
						<input type="submit" value="Create" class="btn login_btn">
					</div>
            </form>
          </article>
        </div>
          ...
          <div class="ps-container">
            <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                    <p>&copy; <a href="#">Loja</a>. Todos os direitos reservados. </p>
                  </div>
                  <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 ">
                    <ul class="ps-social">
